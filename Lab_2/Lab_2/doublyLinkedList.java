...
public class doublyLinkedList<Integer> { // Type restricted to Integer
	...
	public doublyLinkedList() {
		...
		head = new Node<Integer>(null, null, null); // create head ( element, previous, next )

		tail = new Node<Integer>(null, head, null); // tail is preceded by ( element, previous, next )
	...
	private void addBetween(Integer i, Node<Integer> predecessor, Node<Integer> successor) {
		...
		Node<Integer> newest = new Node<Integer>(i, predecessor, successor);
